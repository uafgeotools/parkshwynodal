...
for line in file_in.readlines():
	...
	spec_img = load_pdf_as_image('/scratch/irseppi/nodal_data/plane_info/inversion_results_ngt_320/' + str(equip) + '_spectrum_c/2019'+month+day+'/'+flight_num+'/'+sta+'/'+sta+'_' + str(plot_time) + '.pdf')
	#try:	
	...
	BASE_DIR = '/scratch/irseppi/nodal_data/plane_info/inverse_final_database_pdf_ngt_320/'
