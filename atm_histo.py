...
ax[0,0].set_xlabel('Median temperature:' + str(median_temp))
...
ax[0, 1].set_xlabel('Median wind speed:' + str(median_wind))
...
ax[0, 2].set_xlabel('Median speed of sound:' + str(median_c))
...
ax[1, 0].set_xlabel('Median station temperature:' + str(median_temp))
...
ax[1, 1].set_xlabel('Median station wind speed:' + str(median_wind))
...
ax[1, 2].set_xlabel('Median station speed of sound:' + str(median_c))
...
ax[2, 0].set_xlabel('Median temperature difference:' + str(median_temp))
...
ax[2, 1].set_xlabel('Median wind speed difference:' + str(median_wind))
...
ax[2, 2].set_xlabel('Median speed of sound difference:' + str(median_c))
plt.show()
