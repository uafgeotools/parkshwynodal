...
ax[0, 1].set_xlabel('Median aircraft wind speed: {:.2f}'.format(median_wind))
...
ax[0, 2].set_xlabel('Median aircraftspeed of sound: {:.2f}'.format(median_c))
...
ax[3, 0].set_ylabel('Mean (Aircraft + Station)/2\n' + str(len(air_temp_array)) + ' samples')
...
median_wind = np.median((np.array(air_wind_array) + np.array(sta_wind_array))/2)
...
ax[3, 1].set_xlabel('Median average wind speed: {:.2f}'.format(median_wind))
...
ax[3, 2].set_xlabel('Median average speed of: {:.2f}'.format(median_c))
