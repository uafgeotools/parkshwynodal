...
ax[0,0].set_xlabel('Median temperature:', median_temp)
...
ax[0, 1].set_xlabel('Median wind speed:', median_wind)
...
ax[0, 2].set_xlabel('Median speed of sound:', median_c)
...
ax[1, 0].set_xlabel('Median station temperature:', median_temp)
...
ax[1, 1].set_xlabel('Median station wind speed:', median_wind)
...
ax[1, 2].set_xlabel('Median station speed of sound:', median_c)
