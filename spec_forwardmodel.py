...
forward_model = True
#str(date)+ ',' + str(flight_num) + ',' + str(closest_x_m) + ',' + str(closest_y_m) + ',' + str(dist_m) + ',' +str(closest_time) + ',' + str(alt_avg_m) + ',' + str(speed_avg_mps) + ',' + str(head_avg) + ',' + str(station) + ',' + str(equip) 
#1655.5795851665287,1551066047.2900722,426.72,61.218836,156.0,1022,C185,
#660.0314179850795,1550168082.50959,4876.8,123.46656,15.0,1173,SW4,
#521.5488101799223,1550172821.06195,2933.7000000000003,95.429362,215.5,1272,PA31,
for n in range(0,15):
